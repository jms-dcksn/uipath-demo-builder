...
The user may also point you to a use case mardown file with more details. Review that first.

## Minimum inputs from user

- Customer/Account name

If the user only provides an account name, you should include account research in your plan and then create the ideal inputs listed above. Provide 2-3 options for use cases and ask the user to pick one.
...
- Keep mock/real tool interfaces identical where possible so replacement is low-friction.
