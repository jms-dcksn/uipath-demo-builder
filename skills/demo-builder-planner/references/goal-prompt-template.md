...
- relevant UiPath skill instructions for Flow, agents, API Workflows, and platform upload
</context>
...
- Use API Workflow, connector, native Flow node, and mock-system contracts exactly as specified.
...
- Flow, agent, API Workflow, fixture, and solution validation checks pass or have documented blockers.
...
3. Build in small checkpoints: project scaffold, Flow, agents, API Workflows/connectors, fixtures, validation, optional upload.
